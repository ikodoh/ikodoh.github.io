...
<div class="row">
  ...
  <div class="col-xs-12 col-sm-8 col-md-8">
    ...
    <a href="../index.html"><button type="button" style="color: #fff; background-color: rgb(139, 229, 154); border-color: transparent;" class="btn btn-primary btn-sm">project page</button></a>
